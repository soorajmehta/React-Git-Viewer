                ...
                <div className="panel-body">
                    <div className="row">
                        <div className="col-md-4">
                            <img src={this.props.userData.avatar_url} clasName="thumbnail" style={{ width:"100%" }} />
                        </div>
                        <div className="col-md-8">
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <span className="label label-info">{this.props.userData.followers} Followeres</span>
